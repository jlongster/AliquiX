/* --------------------------------------------------------------
	...
	Description:	This is a class that enables easy and quick profiling of any parts of the system at once.
					...
					I can't take credit for this; I read about it somewhere on gamedev.
...
public:
	AXProfileSample(std::string SampleName);
	virtual ~AXProfileSample();
...
private:
	...
	static struct _ProfileSampleStats {
		...
		float AverageCc;  //average call count
		float MinCc;      //minimum call count
		float MaxCc;      //maximum call count
